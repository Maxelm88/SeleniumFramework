...
public class AllureReportManager extends ReportManager {
    ...
    public byte[] saveScreenshot() {
        ...
        if (Common.driver instanceof RemoteWebDriver && ((RemoteWebDriver) Common.driver).getSessionId() == null) {
    ...
    private void addStepToReport(String type, Throwable t) {
        try {
            switch (type) {
                case "pass":
                    runStepWithDescription(AllureReportManager.class.getDeclaredMethod("reportPassStep"));
                    break;
                case "warn":
                    runStepWithDescription(AllureReportManager.class.getDeclaredMethod("reportWarnStep"));
                    break;
                case "fail":
                    runStepWithDescription(AllureReportManager.class.getDeclaredMethod("reportFailStep", Throwable.class), t);
                    break;
                case "error":
                    runStepWithDescription(AllureReportManager.class.getDeclaredMethod("reportErrorStep", Throwable.class), t);
                    break;
                case "skipp":
                    runStepWithDescription(AllureReportManager.class.getDeclaredMethod("reportSkippedStep"));
                    break;
                default:
    ...
    private String getDefaultMessage(Status s) {
        switch (s) {
            ...
            case SKIPPED:
                return "Test skipped";
            default:
                return "Unable to determine test outcome";
        }
    }
    ...
    private void reportFailStep(Throwable t) {
        ...
        String alertText = (t == null || t instanceof TimeoutException) ? Common.getAlertText(false) : null;
